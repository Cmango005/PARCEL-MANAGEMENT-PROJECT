            ...
            <div className="flex space-x-10 items-center">
                <div >
                    <nav className="hidden lg:flex  lg:space-x-5 lg:gap-6 ">
                        <NavLink to="/"><p className=" text-xl text-red-400 font-bold ">Home</p></NavLink>
                        <NavLink to="/dashboard"><h3 className="text-xl text-red-400 font-bold">Dashboard</h3></NavLink>
                        <div className="indicator">
                            <span className="indicator-item badge badge-secondary bg-pink-500 text-white">0</span>
                            <NavLink to="/notification" ><button className="font-bold text-red-400 text-4xl"><IoIosNotifications /></button></NavLink>
                        </div>
                    </nav>
